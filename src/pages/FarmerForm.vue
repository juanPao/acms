      ...
      <q-card-section class="farmers-bg">
        <div class="row">
          <div class="col-12 col-md-6 q-pa-md">
            <div class="text-h5">
              <q-icon name="groups"></q-icon> Manage Farmers
            </div>
          </div>
          <div class="col-12 col-md-6" align="end">
            <q-btn
              label="Lists of Farmers"
              color="info"
              size="lg"
              icon="list"
              @click="toggleLists()"
                  ...
                  <div class="row">
                    ...
                    <div class="col-6 col-md-8">
                      ...
                      <div
                        class="row"
                        v-if="
                          farmer.main_livelihood_activity ===
                            'Other Fish Activity'
                        "
                      >
                        <q-input
...
export default {
  ...
  created(){
    if(this.edit_mode == true){
      this.SET_CRUD_STEP(1);
      this.farmer = this.$route.params.farmer;
    }
  },
  computed: {
    ...mapState("farmers", ["processingRequest", "crud_step", "edit_mode"]),
  ...
  methods: {
    ...mapActions("farmers", ["storeFarmer", "updateFarmer"]),
    ...
    toggleSave() {
      ...
      this.storeFarmer(this.farmer)
        .then(response => {
          ...
          this.$router.push({path: `/farmer/profile/${response.data.farmer.id}`});
          this.$q.notify({
            type: "positive",
    ...
    toggleUpdate(){
      this.SET_PROCESS_REQUEST(true);
      this.updateFarmer(this.farmer)
      .then(response => {
        this.SET_PROCESS_REQUEST(false);
        this.$router.push({name: "Farmer Profile", params:{farmer_id: response.data.farmer.id}});
      }).catch(error => {
        this.SET_PROCESS_REQUEST(false);
        console.log(error);
      });
